...
namespace SerialPortWriter
{
    ...
    0x43, 0x83, 0x41, 0x81, 0x80, 0x40
        ...
        public static string sn = "UC0018071020001";
        public static byte[] _datarequest =
{
        ...
        public static byte[] _collectrequest =
    {
        ...
        static SerialPort _mySerialPort = new SerialPort("COM3");
       static System.Timers.Timer _t = new System.Timers.Timer(5000);
        ...
        private static void OnTimedEvent(Object source, ElapsedEventArgs e)
        {
                ...
                _mySerialPort.Write(_datarequest, 0, 9);
                Console.WriteLine("Sent" + BitConverter.ToString(_datarequest));
            }
        private static void CalcCRC(ref byte[] bout, int istart, int ilen)
        {
            ...
            int length = ilen;
            int msgIndex = istart;
            while (ilen > 0) /* 传输消息缓冲区*/
            {
                ilen--;
                uIndex = uchCRCHi ^ bout[msgIndex]; /* 计算CRC */
                msgIndex++;
                uchCRCHi = (byte)(uchCRCLo ^ auchCRCHi[uIndex]);
                uchCRCLo = auchCRCLo[uIndex];
            }

            bout[istart + length] = uchCRCHi;
            bout[istart + length + 1] = uchCRCLo;
        }
